...
if getgenv().HATDROP and not getgenv().fullbody then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/funkygonorheraaa/holee-sky-vr-workering-/refs/heads/main/SkyVRHatdrop.lua"))()
	TextLabel.Text = "Ready!"
...
if getgenv().fullbody then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/funkygonorheraaa/holee-sky-vr-workering-/refs/heads/main/SkyVRFullbody.lua"))()
	TextLabel.Text = "Ready!"
	task.delay(5,function()
		loader:Destroy()
	end)
