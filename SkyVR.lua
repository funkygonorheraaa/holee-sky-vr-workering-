...
if getgenv().HATDROP and not getgenv().fullbody then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/396abc/skyvr/refs/heads/main/SkyVRHatdrop.lua"))()
	TextLabel.Text = "Ready!"
...
if getgenv().fullbody then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/396abc/skyvr/refs/heads/main/SkyVRFullbody.lua"))()
	TextLabel.Text = "Ready!"
	task.delay(5,function()
		loader:Destroy()
	end)
